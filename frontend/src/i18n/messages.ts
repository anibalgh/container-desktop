...
export const en: Messages = {
  ...
  settings: {
    ...
    dockerEndpointHint: "Local examples: unix:///var/run/docker.sock (Linux/macOS) | npipe:////./pipe/docker_engine (Windows) | Trusted LAN: tcp://192.168.0.25:2375",
    dockerEndpointRemoteHelpLink: "Need remote connection instructions?",
    dockerEndpointRemoteHelp: {
      title: "Connect to a remote Docker host",
      intro: "Direct tcp:// connections to Docker daemons on a trusted local network are supported. The socat example below applies to a remote Linux/macOS host that exposes a Unix socket. Windows hosts typically use Docker Desktop named pipes and should be exposed through a Windows-specific tunnel or a trusted TCP endpoint instead.",
      installLabel: "Install socat on the remote Linux/macOS host",
      remoteCommandLabel: "Run this on the remote Linux/macOS host",
...
export const es: Messages = {
  ...
  settings: {
    ...
    dockerEndpointHint: "Ejemplos locales: unix:///var/run/docker.sock (Linux/macOS) | npipe:////./pipe/docker_engine (Windows) | LAN confiable: tcp://192.168.0.25:2375",
    dockerEndpointRemoteHelpLink: "¿Necesitas instrucciones para conexión remota?",
    dockerEndpointRemoteHelp: {
      title: "Conectarse a un Docker remoto",
      intro: "Las conexiones directas tcp:// a daemons Docker en una LAN de confianza están permitidas. El ejemplo con socat de abajo aplica a un host remoto Linux/macOS que expone un socket Unix. Los hosts Windows suelen usar named pipes de Docker Desktop y deberían exponerse mediante un túnel específico para Windows o un endpoint TCP de confianza.",
      installLabel: "Instala socat en el host remoto Linux/macOS",
      remoteCommandLabel: "Ejecuta esto en el host remoto Linux/macOS",
